 Vue.component('v-autocompleter', {
    template: ' <div class="czesc"><div class="krzyzyk"><img title="Wyczyść" class="ikona_input-clear" src="iks.png"/><span class="kreska"></span></div><img class="ikona_input-keyboard" src="klawiatura.png"/><img class="ikona_input-mikrofon" src="mikro.png"/><button id="przycisk_szukaj"><img class="ikona_input" src="lupa2.png"/></button></div><div  id="wypisz_miasta" class="miasta_lista" :class="{widok : googleSearch.length > 0 /*&& skupienie*/ && filtrowaneMiasta.length>0}" ><ul ><li  v-for="(miasto,index) in filtrowaneMiasta" ><div class="lista_elementow" :class="{klasa_skupienie:index == zaznaczenie}"><img class="ikona_input" src="lupa2.pnga href="#" v-html="wytluszcz(miasto)" v-on:click="wybrane(index)"><b>{{ miasto }}</b></a> </div></li></ul></div> ',
